...
export default function DarkVeil({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      program.uniforms.uResolution.value.set(width * resolutionScale, height * resolutionScale);
    };
    ...
    const startLoop = () => {
      if (!frame && isInView && document.visibilityState === 'visible') {
  ...
  return <canvas aria-hidden className="darkveil-canvas" ref={ref} />;
}
